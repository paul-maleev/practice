...
def multi_value_post_app(environ, start_response):
    ...
    assert req.form.getlist('field') == [
        'val1', 'val2'], req.form.getlist('field')
...
class TestTestCase(WerkzeugTestCase):
    ...
    def test_environ_builder_stream_switch(self):
        ...
        for use_tempfile in False, True:
            ...
            form = parse_form_data(
                {'wsgi.input': stream, 'CONTENT_LENGTH': str(length),
    ...
    def test_create_environ(self):
        ...
        self.assert_strict_equal(
            create_environ('/foo', 'http://example.com/')['SCRIPT_NAME'], '')
    ...
    def test_follow_redirect(self):
        ...
        self.assert_strict_equal(
            b''.join(appiter), b'current url: http://localhost/some/redirect/')
        ...
        self.assert_strict_equal(
            resp.data, b'current url: http://localhost/some/redirect/')
    ...
    def test_run_wsgi_apps(self):
        ...
        self.assert_strict_equal(
            list(headers), [('Content-Type', 'text/html')])
