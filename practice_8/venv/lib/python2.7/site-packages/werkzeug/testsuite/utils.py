...
class GeneralUtilityTestCase(WerkzeugTestCase):
    ...
    def test_redirect_xss(self):
        ...
        resp = utils.redirect(location)
        self.assert_not_in(
            b'href="http://example.com/?xss="onmouseover="alert(1)"', resp.get_data())
    ...
    def test_import_string(self):
        ...
        self.assert_is(utils.import_string(u'cgi.escape'), cgi.escape)
        self.assert_is(
            utils.import_string(u'werkzeug.debug.DebuggedApplication'), DebuggedApplication)
        self.assert_raises(
    ...
    def test_html_builder(self):
        ...
        self.assert_equal(
            xhtml.input(disabled=True), '<input disabled="disabled" />')
    ...
    def test_validate_arguments(self):
        ...
        self.assert_equal(
            utils.validate_arguments(take_two, (1, 2,), {}), ((1, 2), {}))
        self.assert_equal(utils.validate_arguments(
            take_two, (1,), {'b': 2}), ((1, 2), {}))
        self.assert_equal(utils.validate_arguments(
