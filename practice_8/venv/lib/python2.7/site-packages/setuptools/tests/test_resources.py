...
class DistroTests(TestCase):
    ...
    def testResolve(self):
        ...
        self.assertRaises(
            DistributionNotFound, ws.resolve, parse_requirements(
                "Foo[bar]"), ad
        )
...
class ParseTests(TestCase):
    ...
    def testSplitting(self):
        ...
        self.assertRaises(
            ValueError, list, pkg_resources.split_sections("[foo"))
...
class NamespaceTests(TestCase):
    ...
    def test_two_levels_deep(self):
        ...
        self.assertEqual(
            pkg_resources._namespace_packages["pkg1"], ["pkg1.pkg2"])
